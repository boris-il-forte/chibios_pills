...
/*
 * Setup for Black Pill board.
 */

/*
 * Board identifier.
 */
#define BOARD_STM32F411_BLACKPILL
 ...
 */
#define LINE_KEY                    PAL_LINE(GPIOA, 0U)
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_KEY) |            \
                                     ...
                                     PIN_MODE_INPUT(GPIOA_USART1_TX) |      \
